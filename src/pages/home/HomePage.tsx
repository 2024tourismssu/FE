      ...
      <Box>
         ...
         <Box className={styles.container}>
            ...
            <Box className={styles.container__mainContent}>
               <ActionAreaCard title={'슈니퐁당'} content={'숭실대에서 판매 중인 맛있는 카페집'} image={cafe1} />
               <ActionAreaCard title={'스타벅스'} content={'인어로 우려낸 커피가 자랑인 집'} image={cafe1} />
               <ActionAreaCard title={'미학당'} content={'2호점까지 진출한 새내기'} image={cafe1} />
            </Box>
         </Box>
      </Box>
   )
